...
func (j *JWTManager) GenerateTokenPair(userID primitive.ObjectID, username string, roleID primitive.ObjectID) (*TokenPair, error) {
...
func (j *JWTManager) RefreshToken(refreshTokenString string) (*TokenPair, error) {
    ...
    return j.GenerateTokenPair(claims.UserID, claims.Username, claims.RoleID)
}
